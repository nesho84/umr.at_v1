...
<!--<p style="padding-left: 135px; padding-top: 22px; font-size: 20px; font-weight: bold;">GmbH</p>-->
	...
	<div id="menu">
		<ul>
			<li ><a <?php if ($title == 'Willkommen') { ?>class="current"<?php } ?> href="<?php echo SITE_URL ?>home" title="">Startseite</a></li>
...
<ul class="ppt">
	<li>
    <img src="<?php echo IMAGE_DIR ?>header/top-pic-2.jpg" width="944px" height="150px" alt="">
	<!--<img src="<?php echo IMAGE_DIR ?>header/umrfoto-banner1.png" width="944px" height="150px" alt="">-->
	<li>
	<a href="#">
	<img src="<?php echo IMAGE_DIR ?>header/foto10.jpg" width="944px" height="150px" alt="">
	</a>
	</li>
	<li>
	<img src="<?php echo IMAGE_DIR ?>header/Office_Cleaning.png" width="313px" height="150px" alt="">
	<img src="<?php echo IMAGE_DIR ?>header/stockphoto.jpg" width="310px" height="150px" alt="">
	<img src="<?php echo IMAGE_DIR ?>header/officecleaning-services.jpg" width="313px" height="150px" alt="">
	</li>
	<li>
	<img src="<?php echo IMAGE_DIR ?>header/top-pic-2.jpg" width="944px" height="150px" alt="">
	</li>
	<li>
	<img src="<?php echo IMAGE_DIR ?>header/header77.jpg" width="944px" height="150px" alt="">
	</li>
</ul>
	...
	<div id="sidebar">
		...
		<div id="updates" class="boxed">
			...
			<div class="contentleft">
				<ul>
					<li style="background: url(<?php echo IMAGE_DIR; ?>menu_bullet-2.jpg) no-repeat left center;"><a <?php if ($active == 'Leistungen') { ?>class="active2"<?php } ?> href="<?php echo SITE_URL ?>leistungen/">Leistungen</a></li>
				
				
				<?php
				if ($expand == 'Leistungen') {					
				?>
					<!-- hide down menu
					...
					<li style="background: url(<?php echo IMAGE_DIR?>menu_bullet-2.jpg) no-repeat left center;"><a <?php if ($active == 'Referenzen') { ?>class="active2"<?php } ?> href="<?php echo SITE_URL ?>referenzen/">Referenzen</a></li>
					<!--<li style="background: url(<?php echo IMAGE_DIR?>menu_bullet-2.jpg) no-repeat left center;"><a <?php if ($active == 'News') { ?>class="active2"<?php } ?> href="<?php echo SITE_URL ?>news/">News</a></li>-->
					<li style="background: url(<?php echo IMAGE_DIR?>menu_bullet-2.jpg) no-repeat left center;"><a <?php if ($active == 'PartnerLink') { ?>class="active2"<?php } ?> href="<?php echo SITE_URL ?>partnerlink/">PartnerLink</a></li>
				...
				<ul>
					<li>
						...
						<p style="text-align:justify;"><a href="#">Wir reinigen Ihre Büroräumlichkeiten, Verkaufsräume, Filialen, Lagerflächen, Stiegenhäuser und  Freiflächen zuverlässig und gründlich. Für Bauherren oder Architekten  führen wir bei Bedarf eine professionelle Bauendreinigung durch&#8230;</a></p>
					</li>
					<li>
						<h3>Umzugsreinigung</h3>
						<p style="text-align:justify;"><a href="#">Wir bieten Ihnen die komplette Umzugsreinigung - termingerecht und inklusive Abgabegarantie zu Top Konditionen&#8230;</a></p>
					</li>
					<li>
						<h3>Sonderreinigung</h3>
						<p style="text-align:justify;"><a href="#">Auf Anfrage  führen wir auch Sonderreinigungen durch. Hier können wir im Bedarfsfall auch auf starke und kompetente Partner zurückgreifen&#8230;</a></p>
					</li>
					<li>
						<h3>Gartenpflege</h3>
...
<div id="ad120x600">
<img src="<?php echo IMAGE_DIR ?>ISO-9001.png" width="155px" height="150px" style="border:1px solid #ccc;" />
</div>
</a>

<br /><div id="dotted">&nbsp;</div>    
...
<table width="270" border="0">
  <tr>
    <td width="53"><span style="vertical-align: text-top; font-size: 11px; text-align: inherit;"><img src="<?php echo IMAGE_DIR?>telefon1.png" width="50" height="47"/></span></td>
    <td width="197"><p align="justify" style="vertical-align: middle; font-size: 12px; text-align: left;">Rufen Sie uns an unter:<br> <b><a href="tel:+43(1)8920697">+43(1)8920697</a></b></p></td>
</table>
<script type="text/JavaScript">
<!--
...
//-->
			...
			<tr>
				...
				<td colspan="3" style="border-bottom: 2px dotted #CCCCCC;"><p style="text-align: center; font-weight: bold; font-size: 11px;"><br><?php echo $form_title ?></p>
				</td>
			</tr>
			<tr>
...
<?php ;}?>
			...
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td><br><p style="text-align:right">( <span>* </span>) Pflichtfelder</p>
				</td>
			</tr>
			<tr>		
