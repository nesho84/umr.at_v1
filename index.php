	...
	<div class="content">
		...
		<div id="welcome">
			<p align="justify"><img src="<?php echo SITE_URL ?>/_images/home.jpg" alt="" width="120" height="120" class="left">
				Die <strong style="color:#00a59c">UMR GmbH - </strong> ist ein junges, aufstrebendes und dynamisches Unternehmen.
				Unser Ziel ist Sauberkeit und Qualität zu einem fairen Preis. Die Zufriedenheit unserer Kunden treibt uns an und bestätigt uns täglich in unserer Arbeit.
			</p>
		</div>
		...
		<table width="440px" border="0" style="margin-top:20px; margin-bottom:340px; text-align: left; font-size: 12px">
			<tr>
				<th colspan="2">
			...
			<tr>
				<th scope="row"><img src="<?php echo IMAGE_URL ?>/reinigung/mision1.png" width="123" height="105" alt=""></th>
				<td style="padding-left: 8px;" valign="top">
					Wir betrachten Reinigung als eine essentielle Leistung und Dienst für das Leben.
				</td>
			</tr>
			<tr>
				<th scope="row"><img src="<?php echo IMAGE_URL ?>/reinigung/mision2.png" width="123" height="105" alt=""></th>
				<td style="padding-left: 8px;" valign="top">
					Wir leben den Gedanken der Kundenzufriedenheit durch Flexibilität und Qualität zum fairen Preis.
				</td>
			</tr>
			<tr>
				<th scope="row"><img src="<?php echo IMAGE_URL ?>/reinigung/mision3.png" width="123" height="105" alt=""></th>
				<td style="padding-left: 8px;" valign="top">
