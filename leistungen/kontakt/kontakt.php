...
<table width="650px" border="0">
  <tr>
    <th width="360px" align="left" valign="top" scope="row">
      ...
      <p> <strong>E-mail</strong>: <span style="font-size: 11px;"><a href="mailto:office@umr.at">office@umr.at</a></span></p></th>
...
<div id="dotted">&nbsp;</div>
			...
			<tr>
				<td colspan="3" style="border-bottom: 2px dotted #CCCCCC;"><p style="text-align: center; font-weight: bold; font-size: 16px; color: #618eeb"><br />Wir beraten Sie gerne – selbstverständlich 
