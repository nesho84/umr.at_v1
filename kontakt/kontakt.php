			...
			<table width="650px" border="0">
				<tr>
					...
					<td width="425" align="right">
						...
						<div style="overflow:hidden;height:390px;width:390px;">
							<div id="gmap_canvas" style="height:300px;width:390px;"></div>
							<style>
								#gmap_canvas img {
						...
						<script type="text/javascript">
							function init_map() {
								...
								infowindow = new google.maps.InfoWindow({
									content: "<b>UMR GmbH</b><br/>Penzinger Stra&szlig;e 53<br/>1140 Wien"
								});
				...
				<table class="formbg" align="center" border="0" cellpadding="0" cellspacing="7" width="590px" height="600px" bgcolor="#FFFFFF">
					<tr>
						<td colspan="3" style="border-bottom: 2px dotted #CCCCCC;">
							<p style="text-align: center; font-weight: bold; font-size: 16px; color: #618eeb"><br />Bitte geben sie korrekte informationen für folgende felder ein.</p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>:</td>
						<td>
							<input name="verif_box" type="text" id="verif_box" class="box">
							<img src="<?php echo SITE_URL ?>/kontakt/verificationimage.php?<?php echo rand(1000, 9999); ?>" alt="CAPTCHA" align="absbottom"><br />
