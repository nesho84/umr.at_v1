...
<!--
<li style="font-size: 15px;"><a <?php if ($title == 'Articles') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/articles/index.php">Articles/Pages</a></li>
 
 <li><a <?php if ($title == 'Links') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/links/">Links</a></li>

 <li><a <?php if ($title == 'Photo Gallery') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/gallery/">Photo Gallery</a></li>
 -->

<li><a <?php if ($title == 'Users') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/users/">Users Admin</a></li>

<li><a <?php if ($title == 'Members') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/umr_members/">Members</a></li>

<li><a <?php if ($title == 'StundenListe') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/umr_stundenliste/">StundenListe</a></li>

 <li><a <?php if ($title == 'Firmen') { ?>class="current"<?php } ?> href="<?php echo ADM_URL ?>modules/firmen">Firmen</a></li>
