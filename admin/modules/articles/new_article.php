...
$qry=mysql_query("INSERT INTO articles(title,image,contents,subcategory)VALUES('$tit','$img','$cont','$cat')", $con);
if(!$qry)
{
...
{
?>
<p><img src="<?php echo ADM_URL ?>images/sucess.png" width="40" height="25" />Article <?php echo "<b>".$tit."</b>"; ?> added Successfully</p>
<br />
<?php
}
}
