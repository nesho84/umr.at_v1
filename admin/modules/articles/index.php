...
<tr bgcolor="#FFFFFF"><td colspan="4"><a href=new_category.php >Add Category</a></td></tr>
<tr bgcolor="#FFFFFF"><td colspan="4"><a href=index.php?maincategory_name=<?php echo $row['maincategory_name'];?>>List Categories</a></td></tr>
<tr bgcolor="#FFFFFF"><td colspan="4"><a href=new_article.php >Add Article</a></td></tr>
<tr bgcolor="#FFFFFF"><td colspan="4"><a href=index.php?cat_name=<?php echo $row['cat_name'];?>>List Articles</a></td></tr>
</table>
<!-- Main MENU END -->
<br />
<!-- Categories MENU -->
...
<tr align="" bgcolor="#D22020"> 
<td colspan="4" align="center"><strong style="color: #FFFFFF">Categories::</strong> (<b><?php echo $num_rows; ?></b>)</td>
</tr>
<?php
while($row=mysql_fetch_array($result))
{
?>
<tr bgcolor="#FFFFFF"><td colspan="4" style="text-align:left;"><?php echo "&nbsp;<a href=index.php?subcategory=".$row['cat_name'].">- ".$row['cat_name']."</a>"; ?></td></tr>
<?php
}
?>
</table>
...
?>
<p><img src="<?php echo ADM_URL ?>images/sucess.png" width="40" height="25" />ArticleCategoryID: <b><?php echo $cat_id;?></b> deleted Successfully</p>
<br />
<p align="center"><a href="<?php echo ADM_URL ?>modules/articles/index.php?cat_name=Immobilien">Back to Articles</a></p>
<?php
}
?>
...
$qry=mysql_query("SELECT * FROM articles WHERE subcategory='$subcategory' order by articles.id ASC", $con);
if(!$qry)
{
die("Query Failed: ". mysql_error());
}
...
{
?>
<td><a href="detail.php?id=<?php echo " ".$row['id']." "?>"><img src="<?php echo ADM_URL ?>images/no-image-small.png" width="100" align="left" /></a></td>
<?php
}
...
$qry2 = mysql_query("SELECT * FROM subcategory, maincategory where subcategory.maincategory_name='$cat_name' ", $con);
if (!$qry2) { 
die("Query Failed: ". mysql_error());
}
$row2 = mysql_fetch_array($qry2);

$qry=mysql_query("SELECT * FROM articles order by id ASC ", $con);
if (!$qry)
{
die("Query Failed: ". mysql_error());
}
...
$qry=mysql_query("SELECT image FROM articles WHERE id='$id'", $con);
if(!$qry)
{
die("Query Failed: ". mysql_error());
}
...
?>
<p><img src="<?php echo ADM_URL ?>images/sucess.png" width="40" height="25" />ArticleId: <b><?php echo $id;?> </b>& Image: <b><?php echo $image;?></b> deleted Successfully</p>
<br />
<p align="center"><a href="<?php echo ADM_URL ?>modules/articles/index.php">Back to Articles</a></p>
<?php
}
?>
