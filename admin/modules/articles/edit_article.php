...
$qry=mysql_query("UPDATE articles SET title='$tit',contents='$cont' WHERE id='$id'", $con);
if(!$qry)
{
die("Query Failed: ". mysql_error());
}
...
{
?>
<p><img src="<?php echo ADM_URL ?>images/sucess.png" width="40" height="25" />Article <?php echo "<b>".$tit."</b>"; ?> updated Successfully</p>
<br />
<?php
}
}
...
<textarea name="contents" id="contents" cols="70" rows="12" ><?php echo $row['contents']; ?></textarea></td>
</tr>
<tr>
<td>&nbsp;</td> 
