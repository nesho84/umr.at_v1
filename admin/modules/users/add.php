...
?>
		<p><img src="<?= ADM_URL ?>/images/sucess.png" width="40" height="25" />User <?php echo "<b>" . $username . "</b>"; ?> added Successfully</p>
		<br />
<?php
	} else {
		die('Error : ' . mysqli_error(DBLINK) . '<br /><a href=/albimco/admin/modules/users/add.php><< go back</a>');
	}
}
?>
