...
span { font-size: 12px; margin-bottom: 5px; }
...
select { width: width: 96%; height: 36px; }
</style>
...
if (x==null || x=="")
  {
  alert("Username muss ausgefüllt werden");
  return false;
  }
if (y==null || y=="")
  {
  alert("Password muss ausgefüllt werden");
  return false;
  }
if (z==null || z=="")
  {
...
<tr><th height="40" style="text-align: left; border: 0px;"><h2><strong>Mitarbeiter hinzufügen<div id="hrblue"></div></strong></h2></th></tr>
</table>
...
<tr> <td></td><td align="left"><span style="font-size:10px;">Eingabefelder mit einem ( * ) sind Pflichtfelder.</span></td></tr>
<tr><th width="">Username: </th><td colspan="0" align="left"><input name="username" type="text" class="large-font" id="username" /> * </td></tr>
<tr><th width="">Password: </th><td><input name="password" class="large-font" id="password" value="1234" /> * </td></tr>
<tr><th width="">Name: </th><td><input name="name" class="large-font" id="name" /> * </td></tr>
<tr><th width="">E-mail: </th><td><input name="email" class="large-font" id="email" value="" /></td></tr>
<tr><th width="">Tel.: </th><td><input name="tel" class="large-font" id="tel" /></td></tr>
<tr><th width="">Address: </th><td><input name="address" class="large-font" id="address" /></td></tr>
<tr><td>&nbsp;</td><td align="left"><input name="add" type="submit" class="button" id="add" value="&nbsp;Einfügen&nbsp;" /></td></tr>
</table>
</form>
	<?php
	if(isset($_POST['add']))
	...
	$qry_check = mysql_query("SELECT username FROM members where username='$username' ", $con);
	$qry_check2 = mysql_query("SELECT name FROM members where name='$name' ", $con);
	if(!$qry_check) { die("Query Failed: ". mysql_error()); }
	if(!$qry_check2) { die("Query Failed: ". mysql_error()); }
	$row=mysql_fetch_array($qry_check);
	$row2=mysql_fetch_array($qry_check2);
	...
	{
	die('Error : ' . mysql_error() . '<br /><a href=javascript:history.go(-1)>[Zurück]</a>');
	}
	}
	?>
	<?php go_back(); ?>