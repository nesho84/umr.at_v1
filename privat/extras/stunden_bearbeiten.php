...
.button { width: 80px; background: #3C74E6 url(../_images/img06.gif) repeat-x; font-size: 12px; font-weight: bold; color: #ffffff;
...
<?php
	...
	{
	$qry=mysql_query("SELECT * FROM stundenliste WHERE listeID='$listeID' AND name='$name'", $con);
	}
	else
	{
...
<tr><td height="40" style="border: 0px; text-align: left;"><h2><strong>Stunden Bearbeiten<div id="hrblue"></div></strong></h2></td></tr>
</table>
<span style="font: 11px/24px Verdana, Arial, Helvetica, sans-serif;">
<img src="<?php echo IMAGE_DIR;?>/hinweis.gif" width="20" height="20" style="margin-bottom:-3px;" />
...
<tr><td colspan="2"><hr color="#6699ff" size="1" style="margin-bottom:-1px;" /></td></tr>
<tr>
...
<td style="text-align:right;" valign="top"><span><b>Name:&nbsp;</b><?php echo $name;?></span></td>
	...
	{
	echo "<br /><br /><br />";
	echo "<p align=center style=color:green; font-size:small; class=box>Stunden erfolgreich geändert...</p>";
	?>
