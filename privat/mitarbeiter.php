...
<table width="100%" border="0" align="" cellpadding="1" cellspacing="1" class="boxed">
	<tr>
		<th height="40" align="left">
			<h2><strong>Mitarbeiter - UMR Gmbh<div id="hrblue"></div></strong></h2>
		</th>
	</tr>
</table>
<table width="100%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#ccccff" class="boxed">
	<tr align="" bgcolor="#00a59c">
		<td colspan="7" height="25" style="text-align:right; padding: 4px;" valign="center">
			...
			?>
				<span><a href="<?php echo SITE_URL ?>privat/Mitarbeiter/Hinzufugen"><img src="<?php echo IMAGE_URL; ?>/add_person.png" style="text-align:right; border=0; margin-top: 1px;" width="30" height="30">&nbsp;Mitarbeiter hinzuf�gen&nbsp;</a></span>
			<?php
			}
			?>
		</td>
		...
		<tr bgcolor="#FFFFFF">
			...
			?>
				<td align="center" width="15%">
					...
					<a href="javascript:delMitarbeiter('<?php echo $row['userID'] ?>', '<?php echo $row['username'] ?>');">L�schen</a>
				</td>
			<?php
			}
			?>
...
if (isset($_GET['del_members'])) {
	...
	mysqli_query($query) or die('Error : ' . mysqli_error($con));
	echo "<br /><br />";
	echo "<p align=center style=color:green; font-size:small; class=box>Mitarbeiter erfolgreich gel�scht...</p>";
?>
