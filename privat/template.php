	...
	if (isset($_SESSION['username'])) {
		...
		$qry111 = mysqli_query("SELECT * FROM members where username='$username'");
		$row222 = mysqli_fetch_array($qry111);
	...
	?>
		...
		<head>
			...
			<meta name="description" content="UMR die Reinigungstechnik - die beste Wahl f�r professionelle Reinigung, Service, Schnelligkeit, Sauberkeit, Reinigung ihrer Objekte">
			<meta name="keywords" content="Reinigung, Objektreinigeung, Unterhaltsreinigung, Hauswartungen, Umzugsreinigung, Baureinigung, Fensterreinigung, Fassadenreinigung, B�roreinigung, Teppichreinigung, Sonderreinigung">
			<meta name="robots" content="index, follow" />
			<link rel="shortcut icon" href="<?php echo IMAGE_URL; ?>logo/umr-icon-nn.ico">
			...
			<div id="header">
				...
				<div id="menu">
					<ul>
						...
						<li><a <?php if ($title == 'Umr') { ?>class="current" <?php } ?> href="<?php echo SITE_URL ?>uberumr/">�ber uns</a></li>
		...
		?>
			...
			<div id="mainlong">
				<div id="post" class="boxed">
					<div class="title">
						<h2 style="font-size: 11px; text-transform: none;">
							Hallo <span style="color: #00FF00; font-size: 13.5px;"><?php if (isset($_SESSION['username'])) {
																						echo  $_SESSION['username'];
																					} ?></span>, Sie sind eingeloggt. <a href="<?php echo SITE_URL ?>privat/Logout" style="color: #6600CC; text-decoration: none;"> Ausloggen</a>
						</h2>
					</div>
				...
				function go_back()
				{
					?>
						<br />
						<p style="text-align: center;"><a href="javascript:history.go(-1)"><img src="<?php echo IMAGE_URL; ?>go-back.png" width="50" height="50" style="text-align: center; padding-top: 10px; margin-bottom: -35px;" /></a></p>
					<?php
				}
				function footer()
				{
			...
			<div id="footer">
				<p id="links"><br />
					<a href="<?php echo SITE_URL ?>">Startseite</a> | <a href="<?php echo SITE_URL ?>uberumr/">�ber uns</a> | <a href="<?php echo SITE_URL ?>leistungen/">Leistungen</a>
