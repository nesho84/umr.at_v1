...
<table width="100%" border="0" align="" cellpadding="10" cellspacing="10">
	<tr>
		<td height="40" style="border: 0px;">
			<h2><strong>Kennwort �ndern<div id="hrblue"></div></strong></h2>
		</td>
	</tr>
</table>
<?php
...
if (isset($_POST['edit'])) {
	...
	$qry = mysqli_query("UPDATE members SET password='$new_password' WHERE userID='$userID'", $con);
	if (!$qry) {
		die("Query Failed: " . mysqli_error($con));
	} else {
		echo "<br /><br /><br />";
		echo "<p align=center style=color:green; font-size:small; class=box>Passwort erfolgreich ge�ndert.</p>";
?>
